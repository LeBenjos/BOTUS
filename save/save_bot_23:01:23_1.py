...
# Have rules
async def rules(ctx):
  await ctx.send(f"{ctx.author.mention} :pencil: **Voici les règles du SUTOM :** \nChaque jour à **7h du matin** un mot aléatoire est choisi.\nVous avez **6 essais** pour trouver le mot **crypté en émoji** dont vous ne connaissez que la première lettre! \n\n:pushpin:  **Voici ce que représente les emojis :** \n:blue_square:  - **Lettre qu'on ne connait pas** \n:yellow_circle:  - **La lettre est dans le mot, mais pas au bonne endroit** \n:red_square:  - **La lettre est placé au bonne endroit** \n:regional_indicator_a: [...] :regional_indicator_z:  - **La lettre à son endroit précis** \n\n:pushpin: **Voici la liste des commandes :** \n**!register** : Afin de vous enregister si vous n'avez jamais joué avant \n**!play [langage]** : Afin de commencer une partie dans la langue souhaité \n**!players** : Voir tout les joueurs qui participent \n**!stats [@joueurcible]** : Voir les stats vos stats ou celle du joueur ciblé")
